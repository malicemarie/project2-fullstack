...
const Recipe = require('../controllers/CreateRecipe');

describe('CreateRecipe', () => {
    describe('Initialization', () => {
        it('should create an object with a title', () =>{
            
            const recipe =  new Recipe('Toast',["bread", "butter", "jam", "peanut butter"],'breakfast', 4);
        ...
        it('should create an object with ingredients', () =>{
            ...
            expect(recipe.ingredients).toEqual(["bread", "butter", "jam", "peanut butter"],);
        });
